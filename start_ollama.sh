...
echo "📱 Теперь приложение сможет подключиться по IP: 192.168.2.149:11434"
...
if curl -s http://192.168.2.149:11434/api/tags > /dev/null; then
    echo "✅ Ollama запущена и доступна по сети!"
    echo "📱 В приложении используйте IP: 192.168.2.149:11434"
